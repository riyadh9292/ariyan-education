        ...
        {[...Array(3)].map((_, i) => (
          <div key={i} className="rounded-3xl overflow-hidden animate-pulse"
            ...
            <div className="p-7 flex flex-col items-center">
              <div className="w-24 h-24 rounded-full mb-5 flex-shrink-0"
                style={{ background: "rgba(255,255,255,0.08)" }} />
              <div className="h-4 rounded w-1/2 mb-6" style={{ background: "rgba(255,255,255,0.08)" }} />
              <div className="w-full space-y-3">
                {[...Array(3)].map((_, j) => (
                  <div key={j} className="h-3 rounded" style={{ background: "rgba(255,255,255,0.06)", width: `${75 - j * 10}%` }} />
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 p-7">
            ...
            <div className="rounded-2xl overflow-hidden" style={{ background: "rgba(255,255,255,0.97)" }}>
              <ul className="divide-y divide-gray-50">
                ...
                {/* Address */}
                <li className="flex items-start gap-3 px-4 py-3 group/row hover:bg-blue-50/60 transition-colors">
