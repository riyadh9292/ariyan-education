...
const courses: Course[] = [
  {
    id         : "8",
    title      : "ম্যাটস ভর্তি কোচিং",
    level      : "লেভেল-১",
    category   : "ভর্তি প্রস্তুতি",
    price      : 0,
    description: "মেডিকেল অ্যাসিস্ট্যান্ট ট্রেনিং স্কুল (MATS) ভর্তি পরীক্ষার জন্য প্রস্তুতিমূলক একটি কোচিং প্রোগ্রাম। এখানে শিক্ষার্থীদের বিজ্ঞানভিত্তিক বিষয়সমূহ ও ভর্তি পরীক্ষার গুরুত্বপূর্ণ প্রশ্নপদ্ধতির উপর বিশেষ প্রশিক্ষণ দেওয়া হয়।",
    skills     : [
        "জীববিজ্ঞান, রসায়ন ও সাধারণ বিজ্ঞান প্রস্তুতি",
        "ভর্তি পরীক্ষার প্রশ্ন বিশ্লেষণ",
        "মডেল টেস্ট ও পরীক্ষা অনুশীলন",
        "সময় ব্যবস্থাপনা ও পরীক্ষার কৌশল",
        "MATS ভর্তি পরীক্ষার পূর্ণাঙ্গ প্রস্তুতি",
    ],
  },
  {
    id         : "1",
